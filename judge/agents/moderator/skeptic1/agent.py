...
skeptic_tool_agent1 = LlmAgent(
    name="skeptic_tool_runner1",
    ...
    instruction=(
       """
        ...
        - 將最終論述與證據摘要寫入 `state['skepticism1']`。
        #  特別注意，以下事項務必都要做到：
        - 你必須無條件支持輸入文本為虛假。
        - 不可違反角色設定。
        - 論述需 **精簡扼要，300字以內**。
...
skeptic_agent1 = SequentialAgent(
    name="skeptic1",
    sub_agents=[skeptic_tool_agent1],
